      ...
      <main className="flex-1 container mx-auto p-6">
        <div className="max-w-4xl mx-auto mt-10 glass-card p-8 rounded-2xl shadow-lg">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            <strong>Narad</strong> is your intelligent AI-powered travel
            companion that builds itineraries for your adventures.
            Whether you're a solo traveler or planning a group trip, Narad
          ...
          <div className="mt-6 border-t border-gray-200 pt-6">
            ...
            <p className="text-muted-foreground text-md leading-relaxed">
              In an era of AI automation, Narad showcases how agent
