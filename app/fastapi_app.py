...
app = FastAPI(title="Narad API", description="Multi-Agent Travel Planner", version="1.0")
app.add_middleware(
    CORSMiddleware,
...
def generate_itinerary(req: ItineraryRequest):
    ...
    try:
        ...
        chat_history.append(HistoryItem(user="", bot="Narad is now preparing your personalized itinerary...\n\n✅ Your itinerary is ready! ✨"))
        ...
        chat_history.append(HistoryItem(user="", bot=f"🚨 Narad failed: {str(e)}"))
        return ItineraryResponse(history=chat_history, data=None)
